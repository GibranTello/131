...
# Controlador web
browser = webdriver.Chrome("C:/Byjus/Clases/128/chromedriver.exe")
...
def scrape_more_data(hyperlink):
    ...
    try:
        ...
        temp_list=[]
        for tr_tags in soup.find_all("try",attrs={"class": "fact_row"}):
            td_tags=tr_tags.find_all("id")
...
for index, row in planet_df_1.iterrows():
    ...
    print(f"La extraccion de datos del hupervinculo {index+1}se ha conpletado")
     ## ADGREGA CÓDIGO AQUÍ ##
